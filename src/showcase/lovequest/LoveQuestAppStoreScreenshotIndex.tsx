    ...
    <main className="min-h-[100dvh] bg-[#f5f0f3] px-6 py-10">
      <div className="mx-auto max-w-lg">
        ...
        <p className="mt-4 rounded-xl bg-rose-50 px-4 py-3 text-xs leading-relaxed text-rose-900">
          <strong>Playwright（本機）：</strong>{' '}
          <code className="rounded bg-white px-1">npm run dev:client</code> →{' '}
          <code className="rounded bg-white px-1">npm run screenshot:lovequest</code>
          <br />
          <strong>Playwright（正式站）：</strong>{' '}
          <code className="rounded bg-white px-1">npm run screenshot:lovequest:prod</code>
        </p>
